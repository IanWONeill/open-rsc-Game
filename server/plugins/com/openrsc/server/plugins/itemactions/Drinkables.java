...
public class Drinkables implements InvActionListener , InvActionExecutiveListener {
            ...
            public void init() {
                addState(0, () -> {
                    ...
                    if (id == ItemId.GUJUO_POTION.id())
                        ...
                        if ((((id == ItemId.BRANDY.id()) || (id == ItemId.VODKA.id())) || (id == ItemId.GIN.id())) || (id == ItemId.WHISKY.id())) {
                            handleSpirits(player, item);
                        } else
                            if (((id == ItemId.HALF_COCKTAIL_GLASS.id()) || (id == ItemId.FULL_COCKTAIL_GLASS.id())) || (id == ItemId.ODD_LOOKING_COCKTAIL.id())) {
                                handleCocktail(player, item);
                            } else
                                if ((((id == ItemId.FRUIT_BLAST.id()) || (id == ItemId.BLURBERRY_BARMAN_FRUIT_BLAST.id())) || (id == ItemId.PINEAPPLE_PUNCH.id())) || (id == ItemId.BLURBERRY_BARMAN_PINEAPPLE_PUNCH.id())) {
                                    handleFruitCocktail(player, item);
                                } else
                                    if ((((((((((id == ItemId.BLURBERRY_SPECIAL.id()) || (id == ItemId.BLURBERRY_BARMAN_BLURBERRY_SPECIAL.id())) || (id == ItemId.WIZARD_BLIZZARD.id())) || (id == ItemId.BLURBERRY_BARMAN_WIZARD_BLIZZARD.id())) || (id == ItemId.SGG.id())) || (id == ItemId.BLURBERRY_BARMAN_SGG.id())) || (id == ItemId.CHOCOLATE_SATURDAY.id())) || (id == ItemId.BLURBERRY_BARMAN_CHOCOLATE_SATURDAY.id())) || (id == ItemId.DRUNK_DRAGON.id())) || (id == ItemId.BLURBERRY_BARMAN_DRUNK_DRAGON.id())) {
                                        handleSpecialCocktail(player, item);
                                    } else
                                        if (id == ItemId.BAD_WINE.id())
                                            handleBadWine(player, item);
                                        else
                                            if ((id == ItemId.HALF_FULL_WINE_JUG.id()) || (id == ItemId.WINE.id()))
                                                handleWine(player, item);
                                            else
                                                if (id == ItemId.CHOCOLATY_MILK.id())
                                                    handleChocolatyMilk(player, item);
                                                else
                                                    if (id == ItemId.CUP_OF_TEA.id())
                                                        handleTea(player, item);
                                                    else
                                                        if (id == ItemId.BEER.id())
                                                            handleBeer(player, item);
                                                        else
                                                            if (id == ItemId.GREENMANS_ALE.id())
                                                                handleGreenmansAle(player, item);
                                                            else
                                                                if (id == ItemId.WIZARDS_MIND_BOMB.id())
                                                                    handleWizardsMindBomb(player, item);
                                                                else
                                                                    if (id == ItemId.DWARVEN_STOUT.id())
                                                                        handleDwarvenStout(player, item);
                                                                    else
                                                                        if (id == ItemId.ASGARNIAN_ALE.id())
                                                                            handleAsgarnianAle(player, item);
                                                                        else
                                                                            if (id == ItemId.DRAGON_BITTER.id())
                                                                                handleDragonBitter(player, item);
                                                                            else
                                                                                if (id == ItemId.GROG.id())
                                                                                    handleGrog(player, item);
                                                                                else
                                                                                    if (id == ItemId.POISON_CHALICE.id())
                                                                                        handlePoisonChalice(player, item);
                                                                                    else
                                                                                        if (id == ItemId.FULL_STRENGTH_POTION.id())
                                                                                            useNormalPotion(player, item, 2, 10, 2, ItemId.THREE_STRENGTH_POTION.id(), 3);
                                                                                        else
                                                                                            if (id == ItemId.THREE_STRENGTH_POTION.id())
                                                                                                useNormalPotion(player, item, 2, 10, 2, ItemId.TWO_STRENGTH_POTION.id(), 2);
                                                                                            else
                                                                                                if (id == ItemId.TWO_STRENGTH_POTION.id())
                                                                                                    useNormalPotion(player, item, 2, 10, 2, ItemId.ONE_STRENGTH_POTION.id(), 1);
                                                                                                else
                                                                                                    if (id == ItemId.ONE_STRENGTH_POTION.id())
                                                                                                        useNormalPotion(player, item, 2, 10, 2, ItemId.EMPTY_VIAL.id(), 0);
                                                                                                    else
                                                                                                        if (id == ItemId.FULL_ATTACK_POTION.id())
                                                                                                            useNormalPotion(player, item, 0, 10, 2, 475, 2);
                                                                                                        else
                                                                                                            if (id == ItemId.TWO_ATTACK_POTION.id())
                                                                                                                useNormalPotion(player, item, 0, 10, 2, 476, 1);
                                                                                                            else
                                                                                                                if (id == ItemId.ONE_ATTACK_POTION.id())
                                                                                                                    useNormalPotion(player, item, 0, 10, 2, ItemId.EMPTY_VIAL.id(), 0);
                                                                                                                else
                                                                                                                    if (id == ItemId.FULL_STAT_RESTORATION_POTION.id())
                                                                                                                        useStatRestorePotion(player, item, 478, 2);
                                                                                                                    else
                                                                                                                        if (id == ItemId.TWO_STAT_RESTORATION_POTION.id())
                                                                                                                            useStatRestorePotion(player, item, 479, 1);
                                                                                                                        else
                                                                                                                            if (id == ItemId.ONE_STAT_RESTORATION_POTION.id())
                                                                                                                                useStatRestorePotion(player, item, ItemId.EMPTY_VIAL.id(), 0);
                                                                                                                            else
                                                                                                                                if (id == ItemId.FULL_DEFENSE_POTION.id())
                                                                                                                                    useNormalPotion(player, item, 1, 10, 2, 481, 2);
                                                                                                                                else
                                                                                                                                    if (id == ItemId.TWO_DEFENSE_POTION.id())
                                                                                                                                        useNormalPotion(player, item, 1, 10, 2, 482, 1);
                                                                                                                                    else
                                                                                                                                        if (id == ItemId.ONE_DEFENSE_POTION.id())
                                                                                                                                            useNormalPotion(player, item, 1, 10, 2, ItemId.EMPTY_VIAL.id(), 0);
                                                                                                                                        else
                                                                                                                                            if (id == ItemId.FULL_RESTORE_PRAYER_POTION.id())
                                                                                                                                                usePrayerPotion(player, item, 484, 2);
                                                                                                                                            else
                                                                                                                                                if (id == ItemId.TWO_RESTORE_PRAYER_POTION.id())
                                                                                                                                                    usePrayerPotion(player, item, 485, 1);
                                                                                                                                                else
                                                                                                                                                    if (id == ItemId.ONE_RESTORE_PRAYER_POTION.id())
                                                                                                                                                        usePrayerPotion(player, item, ItemId.EMPTY_VIAL.id(), 0);
                                                                                                                                                    else
                                                                                                                                                        if (id == ItemId.FULL_SUPER_ATTACK_POTION.id())
                                                                                                                                                            useNormalPotion(player, item, 0, 15, 4, 487, 2);
                                                                                                                                                        else
                                                                                                                                                            if (id == ItemId.TWO_SUPER_ATTACK_POTION.id())
                                                                                                                                                                useNormalPotion(player, item, 0, 15, 4, 488, 1);
                                                                                                                                                            else
                                                                                                                                                                if (id == ItemId.ONE_SUPER_ATTACK_POTION.id())
                                                                                                                                                                    useNormalPotion(player, item, 0, 15, 4, ItemId.EMPTY_VIAL.id(), 0);
                                                                                                                                                                else
                                                                                                                                                                    if (id == ItemId.FULL_FISHING_POTION.id())
                                                                                                                                                                        useFishingPotion(player, item, 490, 2);
                                                                                                                                                                    else
                                                                                                                                                                        if (id == ItemId.TWO_FISHING_POTION.id())
                                                                                                                                                                            useFishingPotion(player, item, 491, 1);
                                                                                                                                                                        else
                                                                                                                                                                            if (id == ItemId.ONE_FISHING_POTION.id())
                                                                                                                                                                                useFishingPotion(player, item, ItemId.EMPTY_VIAL.id(), 0);
                                                                                                                                                                            else
                                                                                                                                                                                if (id == ItemId.FULL_SUPER_STRENGTH_POTION.id())
                                                                                                                                                                                    useNormalPotion(player, item, 2, 15, 4, 493, 2);
                                                                                                                                                                                else
                                                                                                                                                                                    if (id == ItemId.TWO_SUPER_STRENGTH_POTION.id())
                                                                                                                                                                                        useNormalPotion(player, item, 2, 15, 4, 494, 1);
                                                                                                                                                                                    else
                                                                                                                                                                                        if (id == ItemId.ONE_SUPER_STRENGTH_POTION.id())
                                                                                                                                                                                            useNormalPotion(player, item, 2, 15, 4, ItemId.EMPTY_VIAL.id(), 0);
                                                                                                                                                                                        else
                                                                                                                                                                                            if (id == ItemId.FULL_SUPER_DEFENSE_POTION.id())
                                                                                                                                                                                                useNormalPotion(player, item, 1, 15, 4, 496, 2);
                                                                                                                                                                                            else
                                                                                                                                                                                                if (id == ItemId.TWO_SUPER_DEFENSE_POTION.id())
                                                                                                                                                                                                    useNormalPotion(player, item, 1, 15, 4, 497, 1);
                                                                                                                                                                                                else
                                                                                                                                                                                                    if (id == ItemId.ONE_SUPER_DEFENSE_POTION.id())
                                                                                                                                                                                                        useNormalPotion(player, item, 1, 15, 4, ItemId.EMPTY_VIAL.id(), 0);
                                                                                                                                                                                                    else
                                                                                                                                                                                                        if (id == ItemId.FULL_RANGING_POTION.id())
                                                                                                                                                                                                            useNormalPotion(player, item, 4, 10, 2, 499, 2);
                                                                                                                                                                                                        else
                                                                                                                                                                                                            if (id == ItemId.TWO_RANGING_POTION.id())
                                                                                                                                                                                                                useNormalPotion(player, item, 4, 10, 2, 500, 1);
                                                                                                                                                                                                            else
                                                                                                                                                                                                                if (id == ItemId.ONE_RANGING_POTION.id())
                                                                                                                                                                                                                    useNormalPotion(player, item, 4, 10, 2, ItemId.EMPTY_VIAL.id(), 0);
                                                                                                                                                                                                                else
                                                                                                                                                                                                                    if (id == ItemId.FULL_CURE_POISON_POTION.id())
                                                                                                                                                                                                                        useCurePotion(player, item, 567, 2);
                                                                                                                                                                                                                    else
                                                                                                                                                                                                                        if (id == ItemId.TWO_CURE_POISON_POTION.id())
                                                                                                                                                                                                                            useCurePotion(player, item, 568, 1);
                                                                                                                                                                                                                        else
                                                                                                                                                                                                                            if (id == ItemId.ONE_CURE_POISON_POTION.id())
                                                                                                                                                                                                                                useCurePotion(player, item, ItemId.EMPTY_VIAL.id(), 0);
                                                                                                                                                                                                                            else
                                                                                                                                                                                                                                if (id == ItemId.FULL_POISON_ANTIDOTE.id())
                                                                                                                                                                                                                                    usePoisonAntidotePotion(player, item, 570, 2);
                                                                                                                                                                                                                                else
                                                                                                                                                                                                                                    if (id == ItemId.TWO_POISON_ANTIDOTE.id())
                                                                                                                                                                                                                                        usePoisonAntidotePotion(player, item, 571, 1);
                                                                                                                                                                                                                                    else
                                                                                                                                                                                                                                        if (id == ItemId.ONE_POISON_ANTIDOTE.id())
                                                                                                                                                                                                                                            usePoisonAntidotePotion(player, item, ItemId.EMPTY_VIAL.id(), 0);
                                                                                                                                                                                                                                        else
                                                                                                                                                                                                                                            if (id == ItemId.FULL_POTION_OF_ZAMORAK.id())
                                                                                                                                                                                                                                                useZamorakPotion(player, item, 964, 2);
                                                                                                                                                                                                                                            else
                                                                                                                                                                                                                                                if (id == ItemId.TWO_POTION_OF_ZAMORAK.id())
                                                                                                                                                                                                                                                    useZamorakPotion(player, item, 965, 1);
                                                                                                                                                                                                                                                else
                                                                                                                                                                                                                                                    if (id == ItemId.ONE_POTION_OF_ZAMORAK.id())
    ...
    private void useNormalPotion(Player player, final Item item, final int affectedStat, final int percentageIncrease, final int modifier, final int newItem, final int left) {
        ...
        int newStat = (baseStat + DataConversions.roundUp((player.getSkills().getMaxStat(affectedStat) / 100.0) * percentageIncrease)) + modifier;
    ...
    private void useZamorakPotion(Player player, final Item item, final int newItem, final int left) {
        ...
        if (player.getSkills().getLevel(Skills.ATTACK) > player.getSkills().getMaxStat(Skills.ATTACK)) {
            ...
            int newStat = baseStat + DataConversions.roundUp((player.getSkills().getMaxStat(Skills.ATTACK) / 100.0) * attackBoost);
        ...
        if (player.getSkills().getLevel(Skills.STRENGTH) > player.getSkills().getMaxStat(Skills.STRENGTH)) {
            ...
            int newStat = baseStat + DataConversions.roundUp((player.getSkills().getMaxStat(Skills.STRENGTH) / 100.0) * strengthBoost);
        ...
        if (player.getSkills().getLevel(Skills.DEFENSE) < player.getSkills().getMaxStat(Skills.DEFENSE)) {
            ...
            int newStat = baseStat - DataConversions.roundUp((player.getSkills().getMaxStat(Skills.DEFENSE) / 100.0) * defenceDecrease);
        ...
        if (player.getSkills().getLevel(Skills.HITS) < player.getSkills().getMaxStat(Skills.HITS)) {
            ...
            int newStat = baseStat - DataConversions.roundUp((player.getSkills().getMaxStat(Skills.HITS) / 100.0) * hitsDecrease);
    ...
    private void handleGujouPotion(Player player) {
        ...
        int drink = Functions.___showMenu(player, "Yes, I'm sure...", "No, I've had second thoughts...");
        if (drink == 0) {
            ...
            Functions.___playerTalk(player, null, "Mmmm.....");
            Functions.sleep(1100);
            player.message("It tastes sort of strange...like fried oranges...");
            Functions.___playerTalk(player, null, ".....!.....");
            Functions.sleep(1100);
            Functions.___message(player, 1300, "You feel somehow different...");
            Functions.___playerTalk(player, null, "Let's just hope that this isn't a placibo!");
        } else
            if (drink == 1) {
    ...
    private void handleCocktail(Player player, Item item) {
        ...
        Functions.checkAndRemoveBlurberry(player, true);
    }

    private void handleFruitCocktail(Player player, Item item) {
        if (player.getSkills().getLevel(Skills.HITS) < player.getSkills().getMaxStat(Skills.HITS)) {
            int newHp = (player.getSkills().getLevel(Skills.HITS) + 8) + (item.getID() == ItemId.PINEAPPLE_PUNCH.id() ? 1 : 0);
            if (newHp > player.getSkills().getMaxStat(Skills.HITS)) {
                newHp = player.getSkills().getMaxStat(Skills.HITS);
            }
            player.getSkills().setLevel(Skills.HITS, newHp);
    ...
    private void handleTea(Player player, Item item) {
        ...
        if (player.getSkills().getLevel(Skills.ATTACK) <= (player.getSkills().getMaxStat(Skills.ATTACK) + (player.getSkills().getMaxStat(Skills.ATTACK) > 55 ? 3 : 2))) {
    ...
    private void handleWizardsMindBomb(Player player, Item item) {
        ...
        if (player.getSkills().getLevel(Skills.MAGIC) <= (player.getSkills().getMaxStat(Skills.MAGIC) + (player.getSkills().getMaxStat(Skills.MAGIC) > 55 ? 3 : 2))) {
    ...
    private void handlePoisonChalice(Player player, Item item) {
        ...
        switch (chance) {
            ...
            case 1 :
                // Hits + 7
                needs = player.getSkills().getMaxStat(Skills.HITS) - player.getSkills().getLevel(Skills.HITS);
                needs = (needs < 7) ? needs : 7;
                player.getSkills().setLevel(Skills.HITS, player.getSkills().getLevel(Skills.HITS) + needs);
                player.message("It heals some health");
                break;
            case 2 :
                // Crafting +1 Attack & Defence -1
                needs = (player.getSkills().getMaxStat(Skills.CRAFTING) + 1) - player.getSkills().getLevel(Skills.CRAFTING);
                needs = (needs < 4) ? needs : 4;
                player.getSkills().setLevel(Skills.CRAFTING, player.getSkills().getLevel(Skills.CRAFTING) + needs);
            ...
            case 3 :
                ...
                player.getSkills().setLevel(Skills.HITS, player.getSkills().getLevel(Skills.HITS) + needs);
                needs = (player.getSkills().getMaxStat(Skills.THIEVING) + 1) - player.getSkills().getLevel(Skills.THIEVING);
                needs = (needs < 1) ? needs : 1;
                player.getSkills().setLevel(Skills.THIEVING, player.getSkills().getLevel(Skills.THIEVING) + needs);
                player.message("You feel a lot better");
                break;
            case 4 :
                // Hits +? Attack, Defence, Strength +4
                needs = player.getSkills().getMaxStat(Skills.HITS) - player.getSkills().getLevel(Skills.HITS);
                needs = (needs < 30) ? needs : 30;
                player.getSkills().setLevel(Skills.HITS, player.getSkills().getLevel(Skills.HITS) + needs);
                needs = (player.getSkills().getMaxStat(Skills.ATTACK) + 4) - player.getSkills().getLevel(Skills.ATTACK);
                needs = (needs < 4) ? needs : 4;
                player.getSkills().setLevel(Skills.ATTACK, player.getSkills().getLevel(Skills.ATTACK) + needs);
                needs = (player.getSkills().getMaxStat(Skills.STRENGTH) + 4) - player.getSkills().getLevel(Skills.STRENGTH);
                needs = (needs < 4) ? needs : 4;
                player.getSkills().setLevel(Skills.STRENGTH, player.getSkills().getLevel(Skills.STRENGTH) + needs);
                needs = (player.getSkills().getMaxStat(Skills.DEFENSE) + 4) - player.getSkills().getLevel(Skills.DEFENSE);
                needs = (needs < 4) ? needs : 4;
                player.getSkills().setLevel(Skills.DEFENSE, player.getSkills().getLevel(Skills.DEFENSE) + needs);
