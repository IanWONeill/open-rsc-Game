...
public class Eating implements InvActionListener , InvActionExecutiveListener {
                    ...
                    if (item.isEdible(player.getWorld()) || (item.getID() == ItemId.ROTTEN_APPLES.id())) {
                        ...
                        if ((id == ItemId.SPECIAL_DEFENSE_CABBAGE.id()) || (id == ItemId.CABBAGE.id())) {
                            if (id == ItemId.SPECIAL_DEFENSE_CABBAGE.id()) {
                                ...
                                player.playerServerMessage(MessageType.QUEST, ("You eat the " + item.getDef(player.getWorld()).getName().toLowerCase()) + ". Yuck!");
                            }
                        } else
                            if (id == ItemId.KEBAB.id()) {
                                isKebabVariant = true;
                                handleKebab(player, item);
                            } else
                                if (id == ItemId.TASTY_UGTHANKI_KEBAB.id()) {
                                    isKebabVariant = true;
                                    handleTastyKebab(player, item);
                                } else
                                    if (id == ItemId.SPINACH_ROLL.id()) {
                                                                            ...
                                                                            if (id == ItemId.DICED_LEMON.id())
                                                                                ...
                                                                                if (id == ItemId.LIME.id())
                                                                                    ...
                                                                                    if ((id == ItemId.LIME_SLICES.id()) || (id == ItemId.LIME_CHUNKS.id()))
                                                                                        ...
                                                                                        if (id == ItemId.ORANGE.id())
                                                                                            player.playerServerMessage(MessageType.QUEST, "You eat the orange ...yum");
                                                                                        else
                                                                                            if (id == ItemId.ORANGE_SLICES.id())
                                                                                                player.playerServerMessage(MessageType.QUEST, "You eat the orange slices ...yum");
                                                                                            else
                                                                                                if (id == ItemId.DICED_ORANGE.id())
                                                                                                    player.playerServerMessage(MessageType.QUEST, "You eat the orange cubes ...yum");
                                                                                                else
                                                                                                    if (id == ItemId.FRESH_PINEAPPLE.id())
                                                                                                        player.playerServerMessage(MessageType.QUEST, "You eat the pineapple ...yum");
                                                                                                    else
                                                                                                        if (id == ItemId.PINEAPPLE_CHUNKS.id())
                                                                                                            player.playerServerMessage(MessageType.QUEST, "You eat the pineapple chunks ..yum");
                                                                                                        else
                                                                                                            if (id == ItemId.CREAM.id())
                                                                                                                player.playerServerMessage(MessageType.QUEST, "You eat the cream..you get some on your nose");
                                                                                                            else
                                                                                                                if (id == ItemId.GNOMEBOWL.id()) {
                                                                                                                    player.playerServerMessage(MessageType.QUEST, "You eat the gnome bowl");
                                                                                                                    player.message("it's pretty tastless");
                                                                                                                    Functions.resetGnomeCooking(player);
                                                                                                                } else
                                                                                                                    if (id == ItemId.GNOMECRUNCHIE.id()) {
                                                                                                                        player.playerServerMessage(MessageType.QUEST, "You eat the gnome crunchies");
                                                                                                                        Functions.resetGnomeCooking(player);
                                                                                                                    } else
                                                                                                                        if ((id == ItemId.CHEESE_AND_TOMATO_BATTA.id()) || (id == ItemId.GNOME_WAITER_CHEESE_AND_TOMATO_BATTA.id())) {
                                                                                                                            player.playerServerMessage(MessageType.QUEST, "You eat the cheese and tomato batta");
                                                                                                                            player.message("it's quite tasty");
                                                                                                                        } else
                                                                                                                            if ((((id == ItemId.TOAD_BATTA.id()) || (id == ItemId.GNOME_WAITER_TOAD_BATTA.id())) || (id == ItemId.WORM_BATTA.id())) || (id == ItemId.GNOME_WAITER_WORM_BATTA.id())) {
                                                                                                                                player.playerServerMessage(MessageType.QUEST, "You eat the " + item.getDef(player.getWorld()).getName().toLowerCase());
                                                                                                                                player.message("it's a bit chewy");
                                                                                                                            } else
                                                                                                                                if ((((id == ItemId.FRUIT_BATTA.id()) || (id == ItemId.GNOME_WAITER_FRUIT_BATTA.id())) || (id == ItemId.VEG_BATTA.id())) || (id == ItemId.GNOME_WAITER_VEG_BATTA.id())) {
                                                                                                                                    player.playerServerMessage(MessageType.QUEST, "You eat the " + item.getDef(player.getWorld()).getName().toLowerCase());
                                                                                                                                    player.message("it's tastes pretty good");
                                                                                                                                } else
                                                                                                                                    if ((((id == ItemId.CHOC_CRUNCHIES.id()) || (id == ItemId.GNOME_WAITER_CHOC_CRUNCHIES.id())) || (id == ItemId.SPICE_CRUNCHIES.id())) || (id == ItemId.GNOME_WAITER_SPICE_CRUNCHIES.id())) {
                                                                                                                                        player.playerServerMessage(MessageType.QUEST, "You eat the " + item.getDef(player.getWorld()).getName().toLowerCase());
                                                                                                                                        player.message("they're very tasty");
                                                                                                                                    } else
                                                                                                                                        if ((((id == ItemId.WORM_CRUNCHIES.id()) || (id == ItemId.GNOME_WAITER_WORM_CRUNCHIES.id())) || (id == ItemId.TOAD_CRUNCHIES.id())) || (id == ItemId.GNOME_WAITER_TOAD_CRUNCHIES.id())) {
                                                                                                                                            player.playerServerMessage(MessageType.QUEST, "You eat the " + item.getDef(player.getWorld()).getName().toLowerCase());
                                                                                                                                            player.message("they're a bit chewy");
                                                                                                                                        } else
                                                                                                                                            if (eatenByParts(player, item)) {
                                                                                                                                                ...
                                                                                                                                                if (itemName.contains("pie")) {
                                                                                                                                                    if (itemName.contains(needleSt + " ")) {
                                                                                                                                                        ...
                                                                                                                                                        if (itemName.contains(needleSt + "n ")) {
                                                                                                                                                ...
                                                                                                                                                if (id == ItemId.ROTTEN_APPLES.id()) {
                                                                                                                                                    // authentic does not give message to quest tab
                                                                                                                                                    Functions.___message(player, "you eat an apple");
                                                                                                                                                    Functions.___playerTalk(player, null, "yuck");
    ...
    private void handleKebab(Player player, Item item) {
        ...
        int hpRestored = 0;
        if (rand == 0) {
            // 1/32 or 3% chance chance of 2-4 damage (can never kill)
            ...
            if (rand <= 1) {
                // 1/32 or 3% chance to heal 30 hits and gaining 1-3 levels att, str, def
                ...
                int[] skills = new int[]{ Skills.ATTACK, Skills.STRENGTH, Skills.DEFENSE };
                ...
                if (rand <= 8) {
                    // 7/32 or 21% chance of healing 10-20 hits
                    ...
                    if (rand <= 28) {
                        // 20/32 or 62% chance of healing 10% max hits
                        player.playerServerMessage(MessageType.QUEST, "It heals some health");
                        hpRestored = (player.getSkills().getMaxStat(Skills.HITS) * 10) / 100;
                    } else {
                        // 3/32 or 9% that does nothing
    ...
    private void handleTastyKebab(Player player, Item item) {
        ...
        switch (DataConversions.random(0, 2)) {
            case 0 :
                Functions.___playerTalk(player, null, "Yummmmm!");
                break;
            case 1 :
                Functions.___playerTalk(player, null, "Oh, so nice!!!");
                break;
            case 2 :
                Functions.___playerTalk(player, null, "Lovely!");
                break;
        }
    }
    ...
    private boolean eatenByParts(Player player, Item item) {
        String itemName = item.getDef(player.getWorld()).getName().toLowerCase();
        return (itemName.contains("cake") || itemName.contains("pie")) || (itemName.contains("pizza") && (!itemName.contains("plain pizza")));
    }
