...
public class SeersPartyChest implements InvUseOnObjectListener , InvUseOnObjectExecutiveListener {
                ...
                addState(0, () -> {
                    ...
                    player.getWorld().getServer().getGameEventHandler().add(new SingleEvent(player.getWorld(), player, DataConversions.random(0, 5000), "Seers Party Hall Drop Delay", true) {
                        ...
                        public void action() {
                            ...
                            while (true) {
                                Point location = (upstairs) ? new Point(rand.nextInt(11) + 490, rand.nextInt(8) + 1408) : new Point(rand.nextInt(11) + 490, rand.nextInt(8) + 464);
