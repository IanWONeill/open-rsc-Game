...
public class SwampToads implements InvActionListener , PickupListener , InvActionExecutiveListener , PickupExecutiveListener {
    @Override
            ...
            return new GameStateEvent(p.getWorld(), p, 0, (getClass().getSimpleName() + " ") + Thread.currentThread().getStackTrace()[1].getMethodName()) {
                public void init() {
                    addState(0, () -> {
                        ...
                        i.remove();
                        Functions.addItem(getPlayerOwner(), ItemId.SWAMP_TOAD.id(), 1);
