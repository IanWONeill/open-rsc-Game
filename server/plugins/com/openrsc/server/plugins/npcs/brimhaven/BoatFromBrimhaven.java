...
public class BoatFromBrimhaven implements IndirectTalkToNpcListener , ObjectActionListener , TalkToNpcListener , IndirectTalkToNpcExecutiveListener , ObjectActionExecutiveListener , TalkToNpcExecutiveListener {
    @Override
                    ...
                    if (sub_opt == 0) {
                        ...
                        if (sub_opt == 1) {
                            if (Functions.hasItem(p, ItemId.KARAMJA_RUM.id(), 1)) {
                                ...
                                Functions.___message(p, "The customs official confiscates your rum");
                                ...
                                if (pay_opt == 0) {
                                    if (Functions.removeItem(p, ItemId.COINS.id(), 30)) {
                                        ...
                                        Functions.movePlayer(p, 538, 617, true);
                ...
                addState(0, () -> {
                    if ((obj.getID() == 320) || (obj.getID() == 321)) {
                        if (command.equals("board")) {
                            ...
                            Npc official = Functions.getNearestNpc(p, NpcId.CUSTOMS_OFFICIAL.id(), 5);
                            if (official != null) {
    ...
    public boolean blockObjectAction(GameObject arg0, String arg1, Player arg2) {
        return ((arg0.getID() == 320) && arg0.getLocation().equals(Point.location(468, 651))) || ((arg0.getID() == 321) && arg0.getLocation().equals(Point.location(468, 646)));
    }
}
