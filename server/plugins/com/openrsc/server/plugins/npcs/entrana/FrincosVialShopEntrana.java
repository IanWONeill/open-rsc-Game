...
public class FrincosVialShopEntrana implements ShopInterface , TalkToNpcListener , TalkToNpcExecutiveListener {
        ...
        return new GameStateEvent(p.getWorld(), p, 0, (getClass().getSimpleName() + " ") + Thread.currentThread().getStackTrace()[1].getMethodName()) {
            public void init() {
                addState(0, () -> {
                    ...
                    int menu = Functions.___showMenu(p, n, "What are you selling?", "You can't, I'm beyond help", "I'm okay, thankyou");
                    if (menu == 0) {
