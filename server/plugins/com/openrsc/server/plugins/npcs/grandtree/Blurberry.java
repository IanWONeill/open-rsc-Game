...
public final class Blurberry implements ShopInterface , TalkToNpcListener , TalkToNpcExecutiveListener {
        ...
        return new GameStateEvent(p.getWorld(), p, 0, (getClass().getSimpleName() + " ") + Thread.currentThread().getStackTrace()[1].getMethodName()) {
            public void init() {
                addState(0, () -> {
                    ...
                    int opt = Functions.___showMenu(p, n, "what do you have", "no thanks");
                    if (opt == 0) {
