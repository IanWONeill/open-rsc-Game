...
public final class BlurberryBarman implements ShopInterface , TalkToNpcListener , TalkToNpcExecutiveListener {
    ...
    public GameStateEvent onTalkToNpc(Player p, final Npc n) {
        return new GameStateEvent(p.getWorld(), p, 0, (getClass().getSimpleName() + " ") + Thread.currentThread().getStackTrace()[1].getMethodName()) {
            public void init() {
                addState(0, () -> {
                    Functions.___npcTalk(p, n, "good day to you", "can i get you drink?");
                    int opt = // do not send over
                    Functions.___showMenu(p, n, false, "what do you have?", "no thanks");
                    if (opt == 0) {
                        Functions.___playerTalk(p, n, "what do you have");
                        ...
                        if (opt == 1) {
                            ...
                            Functions.___npcTalk(p, n, "ok, take it easy");
                        }
