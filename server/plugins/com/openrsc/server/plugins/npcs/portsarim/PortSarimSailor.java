...
public final class PortSarimSailor implements ObjectActionListener , TalkToNpcListener , ObjectActionExecutiveListener , TalkToNpcExecutiveListener {
    @Override
    ...
    public GameStateEvent onObjectAction(GameObject arg0, String arg1, Player p) {
        return new GameStateEvent(p.getWorld(), p, 0, (getClass().getSimpleName() + " ") + Thread.currentThread().getStackTrace()[1].getMethodName()) {
            public void init() {
                addState(0, () -> {
                    Npc sailor = Functions.getNearestNpc(p, NpcId.CAPTAIN_TOBIAS.id(), 5);
                    if (sailor != null) {
    ...
    public boolean blockObjectAction(GameObject arg0, String arg1, Player arg2) {
        return (((arg0.getID() == 155) && arg0.getLocation().equals(Point.location(265, 645))) || ((arg0.getID() == 156) && arg0.getLocation().equals(Point.location(265, 650)))) || ((arg0.getID() == 157) && arg0.getLocation().equals(Point.location(265, 652)));
    }
}
