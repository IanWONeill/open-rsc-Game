...
public class LegendsQuestCaveAgility implements ObjectActionListener , ObjectActionExecutiveListener {
    ...
    public boolean blockObjectAction(GameObject obj, String command, Player p) {
        return Functions.inArray(obj.getID(), LegendsQuestCaveAgility.ROCK_HEWN_STAIRS_1, LegendsQuestCaveAgility.ROCK_HEWN_STAIRS_2, LegendsQuestCaveAgility.ROCK_HEWN_STAIRS_3, LegendsQuestCaveAgility.ROCK_HEWN_STAIRS_4, LegendsQuestCaveAgility.ROCKY_WALKWAY_1, LegendsQuestCaveAgility.ROCKY_WALKWAY_2, LegendsQuestCaveAgility.ROCKY_WALKWAY_3, LegendsQuestCaveAgility.ROCKY_WALKWAY_4);
    }
        ...
        return new GameStateEvent(p.getWorld(), p, 0, (getClass().getSimpleName() + " ") + Thread.currentThread().getStackTrace()[1].getMethodName()) {
            public void init() {
                addState(0, () -> {
                    p.setBusy(true);
                    switch (obj.getID()) {
                        case LegendsQuestCaveAgility.ROCKY_WALKWAY_1 :
                        case LegendsQuestCaveAgility.ROCKY_WALKWAY_2 :
                        case LegendsQuestCaveAgility.ROCKY_WALKWAY_3 :
                        case LegendsQuestCaveAgility.ROCKY_WALKWAY_4 :
                            ...
                            break;
                        case LegendsQuestCaveAgility.ROCK_HEWN_STAIRS_4 :
                            ...
                            break;
                        case LegendsQuestCaveAgility.ROCK_HEWN_STAIRS_3 :
                            if (Functions.getCurrentLevel(p, Skills.AGILITY) < 50) {
                                p.message("You need an agility level of 50 to step these stairs");
                                p.setBusy(false);
                                return null;
                            ...
                            break;
                        case LegendsQuestCaveAgility.ROCK_HEWN_STAIRS_2 :
                            if (Functions.getCurrentLevel(p, Skills.AGILITY) < 50) {
                                p.message("You need an agility level of 50 to step these stairs");
                                p.setBusy(false);
                                return null;
                            ...
                            break;
                        case LegendsQuestCaveAgility.ROCK_HEWN_STAIRS_1 :
                            if (Functions.getCurrentLevel(p, Skills.AGILITY) < 50) {
                                p.message("You need an agility level of 50 to step these stairs");
                                p.setBusy(false);
                                return null;
