...
public class Woodcutting implements ObjectActionListener , ObjectActionExecutiveListener {
    @Override
    ...
    private void handleWoodcutting(final GameObject object, final Player player, final int click) {
        ...
        Functions.showBubble(player, new Item(axeId));
        player.setBatchEvent(new BatchEvent(player.getWorld(), player, 1800, "Woodcutting", Formulae.getRepeatTimes(player, Skills.WOODCUT), true) {
            ...
            public void action() {
                ...
                if (!isCompleted()) {
                    ...
                    Functions.showBubble(getOwner(), new Item(axeID));
                }
            }
        });
    }
